...
class NotificationItem @JvmOverloads constructor(
    ...
    val dismissStartButton: MaterialButton by lazy { findViewById(R.id.dismiss_start) }
    val dismissEndButton: MaterialButton by lazy { findViewById(R.id.dismiss_end) }
    val contentContainer: LinearLayout by lazy { findViewById(R.id.notification_content_container) }
    val icon: ImageView by lazy { findViewById(R.id.icon) }
    val title: TextView by lazy { findViewById(R.id.notification_title) }
    val details: TextView by lazy { findViewById(R.id.notification_details) }
    var statusBarNotification: StatusBarNotification? = null

    var swipeStatus = SwipeStatus.NONE

    init {
        LayoutInflater.from(context).inflate(R.layout.notification_item, this, true)
    }
